...
#define FIRMWARE_VER "1.2.6-custom-autorace"
...
#define WHEEL_TICK2RAD                   (TICK2RAD / MOTOR_TO_WHEEL_RATIO)
#define DISTANCE_PER_MOTOR_TICK          (WHEEL_RADIUS * TICK2RAD / MOTOR_TO_WHEEL_RATIO_ABS)
